...
def convert(source_path: pathlib.Path, destination: pathlib.Path) -> None:
    """Copy a CRX payload after validation.

    Raises:
        SystemExit: The input is not a supported CRX or aliases the output.
